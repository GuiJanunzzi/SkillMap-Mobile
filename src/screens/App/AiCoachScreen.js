  ...
  const handleGetAdvice = async () => {
    ...
    try {
      const response = await api.get(
        `/usuarios/${userInfo.id}/conselho-carreira`
      );
      ...
      const msg =
        ...
        "O Coach IA está indisponível no momento.";
      Alert.alert("Ops!", msg);
    } finally {
      setLoading(false);
    }
    ...
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>
          Conecte suas habilidades atuais com as demandas do futuro do trabalho.
        </Text>
      </View>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.cardText}>
          Nossa IA analisa suas skills atuais e suas metas para sugerir
          estratégias de Upskilling e Reskilling, preparando você para as
