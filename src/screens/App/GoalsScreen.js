...
const styles = StyleSheet.create({
  ...
  fab: { position: 'absolute', width: 56, height: 56, alignItems: 'center', justifyContent: 'center', right: 20, bottom: 20, backgroundColor: '#F57C00', borderRadius: 28, elevation: 8 }, // Cor Laranja para Metas
});