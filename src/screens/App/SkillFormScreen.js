    ...
    <View style={styles.container}>
      ...
      {!isEdit && (
        <View style={styles.tabs}>
          ...
          >
            <Text style={[styles.tabText, mode === 'select' && styles.activeTabText]}>Buscar Existente</Text>
          </TouchableOpacity>
          <TouchableOpacity 
            style={[styles.tab, mode === 'create' && styles.activeTab]} 
            onPress={() => setMode('create')}
          >
            <Text style={[styles.tabText, mode === 'create' && styles.activeTabText]}>Criar Nova</Text>
          </TouchableOpacity>
        </View>
      )}
...
const styles = StyleSheet.create({
  ...
  button: { backgroundColor: '#2E7D32', padding: 15, borderRadius: 8, alignItems: 'center', marginTop: 'auto' },
