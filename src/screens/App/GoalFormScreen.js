...
export default function GoalFormScreen({ route, navigation }) {
  ...
  const renderSkillItem = ({ item }) => (
    ...
    >
      <Text style={styles.modalItemText}>{item.nome}</Text>
      <Text style={[styles.modalItemSub, { color: themeColor }]}>
        {item.categoria?.nome}
      </Text>
    </TouchableOpacity>
  );
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.tabs}>
        ...
        >
          <Text
            style={[styles.tabText, mode === "select" && { color: themeColor }]}
          >
            Buscar Existente
          </Text>
        </TouchableOpacity>
        ...
        >
          <Text
            style={[styles.tabText, mode === "create" && { color: themeColor }]}
          >
            Criar Nova
          </Text>
        </TouchableOpacity>
      ...
      {mode === "select" ? (
        ...
        <View style={styles.formArea}>
          ...
          >
            <Text style={styles.selectButtonText}>
              {selectedCategory ? selectedCategory.nome : "Selecione..."}
            </Text>
